...
DROP TABLE IF EXISTS public.co_po_mappings CASCADE;
...
DROP TABLE IF EXISTS public.bus_tracking CASCADE;
DROP TABLE IF EXISTS public.bus_passes CASCADE;
DROP TABLE IF EXISTS public.bus_drivers CASCADE;
...
DROP TABLE IF EXISTS public.house_points CASCADE;
DROP TABLE IF EXISTS public.house_memberships CASCADE;
